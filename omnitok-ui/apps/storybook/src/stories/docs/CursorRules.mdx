...
- **Logos**:
  - Expandido: `logo_largo_blanco.png` (horizontal blanco, 24px altura, max-width 140px)
  - Colapsado: `logo_cuadrado_color.png` (cuadrado 32x32px)
...
- **Logos**: 
  - Formulario: `logo_largo_color.png`
  - Split panel izquierdo: `logo_largo_blanco.png`
...
<Layout
  sidebarItems={items}
  logo={<img src="logo_largo_blanco.png" />}
  logoCollapsed={<img src="logo_cuadrado_color.png" />}
